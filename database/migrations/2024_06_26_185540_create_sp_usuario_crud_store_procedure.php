...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tbl_usuario] ([nombre_completo], [usuario], [email], [full_admin], [rol_id], [created_at], [created_by])
        VALUES (@nombre_completo, @nameuser, @email, @full_admin, @rol_id, GETDATE(), @usuario);
