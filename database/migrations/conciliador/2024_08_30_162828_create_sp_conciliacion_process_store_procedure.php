...
BEGIN
    ...
    BEGIN
        ...
        FROM (SELECT * FROM [tbl_csv_plataforma] WHERE [plataforma_id] = @csv_plataforma_id AND [procesado] = 0 AND [informacion] = 'REGISTRADO') AS T0, 
        (SELECT * FROM [tbl_csv_icg] WHERE [plataforma_id] = @csv_plataforma_id AND [procesado] = 0) AS T1
